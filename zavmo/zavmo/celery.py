...
CELERY_BROKER_URL = f"rediss://{REDIS_HOST}:{REDIS_PORT}/{REDIS_DB}?ssl_cert_reqs=CERT_NONE&cluster_mode=true"
CELERY_RESULT_BACKEND = f"rediss://{REDIS_HOST}:{REDIS_PORT}/{REDIS_DB}?ssl_cert_reqs=CERT_NONE&cluster_mode=true"
